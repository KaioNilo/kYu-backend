...
exports.sendCustomerConfirmation = exports.sendAdminNotification = void 0;
...
const sendAdminNotification = async (orderData) => {
    ...
    const servicesList = services.map((s) => `<li>${s.description} (x${s.quantity})</li>`).join('');
    try {
...
exports.sendCustomerConfirmation = sendCustomerConfirmation;
